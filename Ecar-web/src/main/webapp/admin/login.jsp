...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">登录Ecar后台管理系统</p>
    <div>
      <label>${errMsg}</label>
    </div>
    <form action="${pageContext.request.contextPath }/admin/common/adminLogin" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="mobile" class="form-control" placeholder="用户名">
